...
void
draw_line_x(int x, int y, int len, int color) {
	int i = 0;
	for (; i < len; i ++) {
...
void
draw_line_y(int x, int y, int len, int color) {
	int i = 0;
	for (; i < len; i ++) {
...
void
draw_square(int x, int y, int size, int color) {
	int i = 0;
	for (; i < size; i ++) {
		draw_line_y(x + i, y, size, color);
	}
}
